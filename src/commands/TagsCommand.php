...
class TagsCommand extends Command
{
	 ...
	 * @var string
	 */
	protected $name = 'laravel-taggable:tags';
	 ...
	 * @var string
	 */
	protected $description = 'Create a migration and model for a tags summary table';
	...
	{
		return $this->argument('table') ?: 'tags';
	}
	...
	{
		$stub = file_get_contents(__DIR__.'/../Mmanos/Taggable/Stubs/TagsMigration.stub.php');
	...
	{
		$stub = file_get_contents(__DIR__.'/../Mmanos/Taggable/Stubs/TagModel.stub.php');
	...
	{
		return array(
			array('table', InputArgument::OPTIONAL, 'The name of your tags table (default is tags).'),
		);
	}
}
